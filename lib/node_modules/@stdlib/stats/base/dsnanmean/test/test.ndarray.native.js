...
var dsnanmean = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 4', opts, function test( t ) {
	t.strictEqual( dsnanmean.length, 4, 'has expected arity' );
	t.end();
});
